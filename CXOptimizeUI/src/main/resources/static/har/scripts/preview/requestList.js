        ...
        TABLE({"class": "netTable", cellpadding: 0, cellspacing: 0, onclick: "$onClick",
            ...
            TBODY(
                TR({"class" : "netSizerRow"},
                   ...
                   TD({"class": "netStatusCol netCol", width: "0%"}),
                    TD({"class": "netTypeCol netCol", width: "0%"}),
                    TD({"class": "netDomainCol netCol", width: "0%"}),
                    TD({"class": "netSizeCol netCol", width: "0%"}),
                    TD({"class": "netTimeCol netCol", width: "80%"}),
