...
public class ApiControllerTest
{
    ...
    private void setAuthToken() throws Exception
    {
        if(authToken == null)
        {
            String authJson = "{\"username\":\"cxopuser\",\"password\":\"zxcvbnm\"}";
